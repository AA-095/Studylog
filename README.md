...
## ロードバランサー
- サーバーを増強する方法をスケールアップと呼ぶ。コストをかければ処理能力は向上するが、処理能力にも限界があるため、かけたコストと性能の向上は比例しない。一方、サーバーの台数を増やす方法をスケールアウトと呼ぶ。サーバー台数を二倍に増やせば、性能も比例して向上するため、費用対効果が高く、スケーラビリティに優れている。
